...
interface QH { id: string; text: string; answer: string; userAnswer: string; isCorrect: boolean; playedAt: string; questionId?: number }
            ...
            <div style={{ display:'flex', alignItems:'flex-start', gap:10 }}>
              ...
              <div style={{ flex:1, minWidth:0 }}>
                ...
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginTop:6 }}>
                  ...
                  {q.questionId && (
                    <button onClick={() => setReportTarget({ id: q.questionId!, text: q.text })}
                      style={{ background:'none', border:'none', cursor:'pointer', color:'var(--muted)', fontSize:11, padding:'2px 6px', borderRadius:6, display:'flex', alignItems:'center', gap:3 }}>
                      🚩 報告
                    </button>
                  )}
                </div>
